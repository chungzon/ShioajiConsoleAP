...
class DataAnalysisController:
    ...
    def show_detail_data(self):
        ...
        total_segment, recent_segment, gap_df, now_price = self.model.get_stock_data_from_all_wave_extremes(stock_id, start_date, end_date, recent_start_date, recent_end_date)
        ...
        self.view.show_sma_data(stock_id, stock_name, organized_ma_data, recent_ratio_prices, additional_data, indicator_prices, total_ratio_prices, gap_df, now_price)
