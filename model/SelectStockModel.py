    ...
    def get_top_volumn_stocks(self):
        try:
            ...
            if '股票代號' in stock_df.columns:
                # 獲取前 50 筆的股票代號
                top_50_stocks = stock_df['股票代號'][:20]
